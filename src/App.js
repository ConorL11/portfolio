      ...
      <div className="lg:flex lg:justify-between lg:gap-4">
        <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
          <div>
            ...
            <p className="mt-4 max-w-xs leading-normal">I lead Software Implementations, provide technical guidance, and build custom interfaces and other cool stuff on the </p>
        ...
        <main id="content" className="pt-24 lg:w-1/2 lg:py-24">
          <section id="about" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
            ...
            <div>
              <p className="mb-4">While pursuing a degree in Industrial Engineering, I discovered a passion for programming. After working a couple of internships in the manufacturing industry, I decided to pivot my career and look for jobs in Tech. Since then I've had the privilege of working for a small business, and a rapidly scaling startup. In addition to this, I've been able to practice my technical skills by pursuing a number of personal (primarly sports focused) projects.</p>
                ...
                <li className="mb-12">
                  <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                    ...
                    <div className="z-10 sm:col-span-6">
                      ...
                      <p className="mt-2 text-sm leading-normal">Developed custom interfaces and utilities for customer needs and to improve Customer Success processes and efficiency.</p>
          ...
          <footer className="max-w-md pb-16 text-sm text-stone-500 sm:pb-0">
            <p>
              Portfolio built with <a target="_blank" rel="noreferrer" href="https://react.dev/" className="text-stone-400">React</a> and <a target="_blank" rel="noreferrer" href="https://tailwindcss.com/" className="text-stone-400">Tailwind CSS</a>.
            </p>
          </footer>
        </main>
      </div>
