      ...
      <div className="lg:flex lg:justify-between lg:gap-8">
        ...
        <main id="content" className="lg:pt-24 lg:w-2/3 pt-8 lg:py-24">
          <section id="about" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
            ...
            <div>
              <p className="mb-4">While pursuing a degree in Industrial Engineering at Purdue University, I discovered a passion for programming and analytical problem solving. After graduation, I started my career at a small business providing CPQ solutions to the manufacturing industry. I then shifted to a rapidly scaling company building OKR software. Today I am working with monday.com doing implementations and custom app development. All of these companies have allowed me to combine my soft skills and desire to interact with customers with my technical abilities. In addition to this, I've been able to practice my technical skills by pursuing a number of personal (primarily sports focused) projects.</p>
